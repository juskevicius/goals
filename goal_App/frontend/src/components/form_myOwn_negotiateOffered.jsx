      ...
      <div className="overlay" onClick={(event) => this.props.toggleDisplayForm("formNegotiateOffered", null, event)}>
        <div className="form-negotiateOffered">
          ...
          <div className="form-body">
            <form>
              <h4>An offer from {this.props.goal.offer.owner.name} {this.props.goal.offer.updated_formatted ? this.props.goal.offer.updated_formatted : this.props.goal.offer.created_formatted}:</h4>
              <label>Goal:</label>
            ...
            <form>
              <h4>My response{this.props.goal.updated_formatted ? ' ' + this.props.goal.updated_formatted : ''}:</h4>
              <label>Goal:</label>
